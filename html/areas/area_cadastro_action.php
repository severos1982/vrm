...
$sql = "insert into area (are_setor, are_nome, are_descricao, are_disponibilidade) values (" .$setor. ", '" . $area . "', '" . $descricao . "', " .$disponibilidade. ")";
...
<ul class="nav nav-tabs">
  <li role="presentation">
  	<a href="../principal.php?pg=setor" target="mainFrame">Setor</a>
  	</li>
